  ...
  <div class="col-md-12 well">
    ...
    <form role="form" action="/smtp-providers/add" method="post">
      <div class="form-group <?= isset($errors['name'])? 'has-error has-feedback': '' ?>">
        ...
        <input type="text" name="name" class="form-control" id="smtp-name" placeholder="Name" value="<?= isset($input['name'])? $input['name'] : '' ?>">
      ...
      <div class="form-group <?= isset($errors['host'])? 'has-error has-feedback': '' ?>">
        ...
        <input type="text" name="host" class="form-control" id="smtp-host" placeholder="Host" value="<?= isset($input['host'])? $input['host'] : '' ?>">
      ...
      <div class="form-group <?= isset($errors['username'])? 'has-error has-feedback': '' ?>">
        ...
        <input type="text" name="username" class="form-control" id="smtp-username" placeholder="Username" value="<?= isset($input['username'])? $input['username'] : '' ?>" >
      ...
      <div class="form-group <?= isset($errors['port'])? 'has-error has-feedback': '' ?>">
        ...
        <input type="text" name="port" class="form-control" id="smtp-port" placeholder="Port" value="<?= isset($input['port'])? $input['port'] : '' ?>">
